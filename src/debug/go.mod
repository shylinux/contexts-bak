...
require shylinux.com/x/ice v0.4.5

require (
	shylinux.com/x/golang-story v0.2.8
	shylinux.com/x/linux-story v0.2.8
	shylinux.com/x/mysql-story v0.3.0
	shylinux.com/x/nginx-story v0.2.9
	shylinux.com/x/redis-story v0.3.0
)
