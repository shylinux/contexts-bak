...
require shylinux.com/x/ice v0.4.9

require (
	shylinux.com/x/golang-story v0.3.1
	shylinux.com/x/linux-story v0.3.1
	shylinux.com/x/mysql-story v0.3.3
	shylinux.com/x/nginx-story v0.3.2
	shylinux.com/x/redis-story v0.3.3
)
